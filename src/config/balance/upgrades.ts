...
export const UPGRADE_DEFINITIONS: UpgradeDefinition[] = [
  ...
  { id: "warriorRegeneration", group: "warriors", label: "Warrior Regeneration", effect: "+0.5 regen/sec", baseCost: { ore: 6 } },
  ...
  { id: "gathererRegeneration", group: "gatherers", label: "Gatherer Regeneration", effect: "+0.5 regen/sec", baseCost: { wood: 6 } },
